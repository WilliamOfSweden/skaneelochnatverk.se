...
Permission is granted to use this software for educational and presentational purposes only. You are not allowed to use this software publicly and/or commercially.
