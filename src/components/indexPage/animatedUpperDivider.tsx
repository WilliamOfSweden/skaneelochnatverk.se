...
const StyledSVG = styled.svg`
    ...
    @keyframes upperDivider { 0% {stroke-dashoffset: 0 } to {stroke-dashoffset: -100% } }
    
    animation: upperDivider 70s linear infinite;
...
export default AnimatedUpperDivider
